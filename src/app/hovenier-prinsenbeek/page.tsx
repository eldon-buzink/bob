...
export const metadata: Metadata = {
  title: "Hovenier Prinsenbeek | Bobsgroen Hoveniers",
  description: "Professionele hovenier in Prinsenbeek. Tuinontwerp, tuinaanleg en periodiek onderhoud. Gratis offerte. 10+ jaar ervaring. Bel direct voor advies!",
  openGraph: {
    title: "Hovenier Prinsenbeek | Bobsgroen Hoveniers",
    description: "Professionele hovenier in Prinsenbeek. Tuinontwerp, tuinaanleg en periodiek onderhoud. Gratis offerte.",
    url: `${siteConfig.site.url}/hovenier-prinsenbeek`,
  },
  alternates: {
    canonical: `${siteConfig.site.url}/hovenier-prinsenbeek`,
  },
};

export default function HovenierPrinsenbeekPage() {
  return (
    <div className="py-16">
      <div className="container">
        ...
        <div className="text-center mb-16">
          <h1 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
            Hovenier in Prinsenbeek
          </h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Op zoek naar een betrouwbare hovenier in Prinsenbeek? Bobsgroen Hoveniers is uw lokale specialist 
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <p className="text-gray-600 mb-4">
              Professioneel tuinontwerp dat perfect aansluit bij uw wensen en de omgeving van Prinsenbeek.
            </p>
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <p className="text-gray-600 mb-4">
              Regelmatig onderhoud om uw tuin in Prinsenbeek het hele jaar door in topconditie te houden.
            </p>
        ...
        <div className="bg-muted rounded-2xl p-8 mb-16">
          <h2 className="text-3xl font-bold text-gray-900 text-center mb-8">
            Waarom Kiezen voor Bobsgroen in Prinsenbeek?
          </h2>
        ...
        <div className="bg-primary text-white rounded-2xl p-12 text-center">
          <h2 className="text-3xl lg:text-4xl font-bold mb-4">
            Klaar voor Uw Project in Prinsenbeek?
          </h2>
        ...
        <div className="mt-16 text-center">
          <div className="flex items-center justify-center space-x-2 text-gray-600 mb-4">
            ...
            <span className="text-lg">Ook actief in: Etten-Leur, Zevenbergen, Breda, Roosendaal, Sprundel, Hoeven</span>
          </div>
        </div>
      </div>
    </div>
